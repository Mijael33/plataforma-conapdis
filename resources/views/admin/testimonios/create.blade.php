...
@section('titulo', 'Crear Testimonio')

@section('contenido')
<div class="container-fluid">
    <h2 style="color: #1a3b5d; font-weight: 700;" class="mb-4">Crear Nuevo Testimonio</h2>
        ...
        <form action="{{ route('admin.testimonios.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="nombre_autor" class="form-control rounded-3" value="{{ old('nombre_autor') }}" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-bold">Cargo</label>
                    <input type="text" name="cargo_autor" class="form-control rounded-3" value="{{ old('cargo_autor') }}" placeholder="Ej: Estudiante UCV" required>
                </div>
                <div class="col-12">
                    <label class="form-label fw-bold">Testimonio</label>
                    <textarea name="testimonio" class="form-control rounded-3" rows="5" required>{{ old('testimonio') }}</textarea>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    <button type="submit" class="btn btn-warning rounded-pill px-4">Guardar Testimonio</button>
