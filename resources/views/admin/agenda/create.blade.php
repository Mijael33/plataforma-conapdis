...
<div class="container-fluid">
    <h2 style="color: #1a3b5d; font-weight: 700;" class="mb-4">Nuevo Evento de Agenda</h2>
        ...
        <form action="{{ route('admin.agenda.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" name="fecha" class="form-control rounded-3" value="{{ old('fecha') }}" required>
                </div>
                <div class="col-md-3">
                    <label class="form-label fw-bold">Hora</label>
                    <input type="text" name="hora" class="form-control rounded-3" value="{{ old('hora') }}" placeholder="Ej: 9:00 am">
                </div>
                <div class="col-12">
                    <label class="form-label fw-bold">Lugar</label>
                    <input type="text" name="lugar" class="form-control rounded-3" value="{{ old('lugar') }}" placeholder="Ej: Sede Central">
                </div>
                <div class="col-12">
                    <label class="form-label fw-bold">Extracto</label>
                    <textarea name="extracto" class="form-control rounded-3" rows="2">{{ old('extracto') }}</textarea>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    <button type="submit" class="btn btn-success rounded-pill px-4">Guardar Evento</button>
