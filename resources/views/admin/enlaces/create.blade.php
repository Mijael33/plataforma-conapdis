...
@section('titulo', 'Nuevo Enlace')

@section('contenido')
<div class="container-fluid">
    <h2 style="color: #1a3b5d; font-weight: 700;" class="mb-4">Nuevo Enlace - CONAPDIS en Línea</h2>
        ...
        <form action="{{ route('admin.enlaces.store') }}" method="POST">
            ...
            <div class="row g-3">
                <div class="col-md-8">
                    ...
                    <input type="text" name="titulo" class="form-control rounded-3" placeholder="Ej: Registro Organizaciones Sociales" required>
                </div>
                <div class="col-md-4">
